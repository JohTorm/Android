...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ListView listView;
    ArrayList<Competition> listItem = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<Competition>(this, android.R.layout.simple_list_item_1,listItem);
